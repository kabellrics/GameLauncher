...
namespace GameLauncher.DAL.Migrations
{
    ...
    [Migration("20240605154514_ItemGenreFix")]
    partial class ItemGenreFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameLauncher.Models.LUPlatformes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("a340b5d3-d942-4ab5-aceb-0a4833ee5f32"),
                            CodeName = "Steam",
                            Databases = "",
                            Name = "Steam"
                        },
                        new
                        {
                            ID = new Guid("5c5c941d-1974-4128-bbb2-7b9ed74392cc"),
                            CodeName = "Epic",
                            Databases = "",
                        ...
                        new
                        {
                            ID = new Guid("7e4267b7-0831-4020-9e62-96bfc45bfa40"),
                            CodeName = "EA Play",
                            Databases = "",
                            Name = "EA Origin"
                        });
