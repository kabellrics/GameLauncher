...
namespace GameLauncher.DAL.Migrations
{
    ...
    [Migration("20240605144455_FavoriteItem")]
            ...
            modelBuilder.Entity("GameLauncher.Models.LUPlatformes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("8b01f713-3edf-4109-b812-9aad9843e3de"),
                            CodeName = "Steam",
                            Databases = "",
                            Name = "Steam"
                        },
                        new
                        {
                            ID = new Guid("63bc39f7-3e97-40b3-9693-8cb6a9b24ab6"),
                            CodeName = "Epic",
                            Databases = "",
                        ...
                        new
                        {
                            ID = new Guid("e4fe562b-3c61-45d1-8b15-66e43a9417e5"),
                            CodeName = "EA Play",
                            Databases = "",
                            Name = "EA Origin"
                        });
