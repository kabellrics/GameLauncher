...
namespace GameLauncher.DAL.Migrations
{
    ...
    [Migration("20240605141752_ChangeIDForLuPlatforms")]
    partial class ChangeIDForLuPlatforms
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameLauncher.Models.LUPlatformes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("dfd2dc9e-45b1-47e4-b3d7-facf70ca307d"),
                            CodeName = "Steam",
                            Databases = "",
                            Name = "Steam"
                        },
                        new
                        {
                            ID = new Guid("3ac48107-1aed-4065-98c7-a54351e7a892"),
                            CodeName = "Epic",
                            Databases = "",
                        ...
                        new
                        {
                            ID = new Guid("5ee9bded-6dcf-43db-a4ce-7f2fb23415e7"),
                            CodeName = "EA Play",
                            Databases = "",
                            Name = "EA Origin"
                        });
