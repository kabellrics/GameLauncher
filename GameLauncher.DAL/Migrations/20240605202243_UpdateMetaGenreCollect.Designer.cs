...
namespace GameLauncher.DAL.Migrations
{
    ...
    [Migration("20240605202243_UpdateMetaGenreCollect")]
    partial class UpdateMetaGenreCollect
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameLauncher.Models.LUPlatformes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("1a1c6ae1-b68e-4bc8-8a65-b1b0071d4eed"),
                            CodeName = "Steam",
                            Databases = "",
                            Name = "Steam"
                        },
                        new
                        {
                            ID = new Guid("d668c5af-83da-499e-985b-d63fb1d05a71"),
                            CodeName = "Epic",
                            Databases = "",
                        ...
                        new
                        {
                            ID = new Guid("04238591-e166-4403-a53e-590debd243eb"),
                            CodeName = "EA Play",
                            Databases = "",
                            Name = "EA Origin"
                        });
            ...
            modelBuilder.Entity("ItemMetadataGenre", b =>
                {
                    b.Property<Guid>("ItemsID")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("MetadataGenresID")
                        .HasColumnType("TEXT");

                    b.HasKey("ItemsID", "MetadataGenresID");

                    b.HasIndex("MetadataGenresID");

                    b.ToTable("ItemMetadataGenre");
                });
            ...
            modelBuilder.Entity("ItemMetadataGenre", b =>
                {
                    ...
                    b.HasOne("GameLauncher.Models.MetadataGenre", null)
                        .WithMany()
                        .HasForeignKey("MetadataGenresID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
