...
public sealed partial class Default : UserControl
{
    public Default()
    {
    ...
    private async void CollectionList_SelectionChanged(object sender, Microsoft.UI.Xaml.Controls.SelectionChangedEventArgs e)
    {
        try
        {
            ...
            if (this.Visibility == Visibility.Visible && CollectionList.IsLoaded == true && CollectionList.Items.Any())
            {
                ...
                await CollectionList.SmoothScrollIntoViewWithItemAsync(CollectionList.SelectedItem, ScrollItemPlacement.Left, false, true);
            }
        }
