...
using GameLauncher.AdminWPF.Core.Contracts.Services;
using GameLauncher.AdminWPF.Core.Services;
using GameLauncher.AdminWPF.Models;
using GameLauncher.AdminWPF.Services;
using GameLauncher.AdminWPF.ViewModels;
using GameLauncher.AdminWPF.Views;

using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;

namespace GameLauncher.AdminWPF;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddTransient<EmulatorImporterViewModel>();
        services.AddTransient<EmulatorImporterPage>();
        ...
        services.AddTransient<DevellopeurViewModel>();
        services.AddTransient<DevellopeurPage>();
